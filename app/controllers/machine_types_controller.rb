class MachineTypesController < ApplicationController
  ...
  private
    ...
    def machine_type_params
      params.require(:machine_type).permit(:kind, :google_id, :creation_timestamp, :name, :description, :guest_cpus, :memory_mb, :image_space_gb, :maximum_persistent_disks, :maximum_persistent_disks_size_gb, :zone, :self_link, :is_shared_cpu)
    end
end
